  ...
  return (
    <div className="signup">
      <div className="flex h-screen gap-30">
        <div className="w-1/2">
        <img src="/images/photo3.png" alt="photo3" className="w-150 h-130 mt-10 ml-10" />
        <p className="absolute bottom-23 font-bold left-20 text-white text-[30px]  ">
         Lorem Ipsum is simply
         </p>
         <p className="absolute bottom-15 font-meduim left-20 text-white text-[20px] ">
         Lorem Ipsum is simply
         </p>
        </div>
        <div className="w-1/2 mt-20  ">
          ...
          <div className="flex bg-[#6783F4] rounded-full w-60  p-1.5  mt-5 ml-20">
            <button className="rounded-full bg-[#4957BD] text-white font-medium px-4 py-1.5 flex flex-col gap-3 w-[200px]">login</button>
            <button className="rounded-full bg-[#6783F4] text-white font-medium text-center px-4 py-1.5 w-[150px] ">signUp</button>
          </div>
         ...
         <div className="relative">
          ...
          <div className="flex justify-between items-center text-[13px] mt-5 text-gray-700">
            <div className="flex items-center ml-10"> 
             <img src="/images/photo4.svg" alt="photo4" className="w-5.5 h-3.5 cursor-pointer"/>
             <span > Remember me</span>
            </div>
            <span className=" mr-45 hover:underline cursor-pointer">Forgot Password?</span>
          </div>
          
         <button className="text-white rounded-full px-4 py-1.5 bg-[#495CBD] w-[180px] block mt-10 ml-58 hover:opacity-80 transition">login</ button>
        </div>
      </div>
