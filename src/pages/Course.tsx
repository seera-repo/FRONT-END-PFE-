...
const Course = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f5f9fb]">
      ...
      <main className="flex-1 mt-17 flex flex-col min-h-screen bg-[#f2f2f5]">
        {/* Hero Banner */}
        ...
        <div className="mx-auto max-w-5xl px-6 pb-12 ">
          ...
          <div className=" relative z-10 flex flex-col gap-8 lg:flex-row">
            ...
            <div className="flex-1 ">
              ...
              {/*course info */}
              <div className="rounded-2xl border-border shadow-lg bg-white text-card-foreground flex flex-col gap-6 border py-6 ">
