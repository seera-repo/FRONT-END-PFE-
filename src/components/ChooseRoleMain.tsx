...
import { fetchTeacherRole } from "../api/role";
import logo from "../assets/images/Asset_14x.png";
import { fetchStudentRole } from "../api/role";
...
function ChooseRoleMain() {
    ...
    const [loading, setLoading] = useState(false);    
        ...
        async function handleStudentRole() {
            setLoading(true);
            try {
                await fetchStudentRole();
                // redirect or show success
            } catch (err) {
                setError("Something went wrong, try again");
            } finally {
  ...
  <p
    id="chooseTitleRole"
    className="cursor-default text-[28px]  text-[#A7A9E9]"
  >
    Welcome to
  </p>

  {/* Logo */}
  <a className="flex items-center gap-x-2 shrink-0">
    <img
      src={logo}
      alt="Logo"
    ...
    />
                ...
                <p id="chooseTextRole" className="cursor-default  text-[22px] font-normal mt-0 text-[#2e2c74]">
                ...
                <div className="chooseFlex flex flex-row gap-[30px] mt-[60px] ml-0">
                    ...
                    onClick={(e) => {
                        ...
                        <h2 id="choosePartTitleRole1" className="font-['Geist',sans-serif] text-[25px] font-semibold mt-[15px] text-[#2e2c74]">I'm a Student</h2>
                        ...
                        <a className="choosePartLinkRole font-['Geist',sans-serif] text-[17px] font-medium mt-[40px] text-[#2e2c74]">Get Started  </a>
                    </div>
                    <div className="choosePart relative w-[350px] h-[460px] flex flex-col items-center justify-center rounded-[20px] border-[3px] border-[rgba(104,108,184,0.39)] bg-[rgba(167,170,233,0.39)] transition-[opacity,filter] duration-[3000ms] ease-in-out cursor-pointer hover:-translate-y-[3px] hover:scale-105 hover:shadow-[0_12px_25px_rgba(0,0,0,0.3)]" 
                    onClick={(e) => {
                        const btn = e.currentTarget;
                        ...
                        <h2 id="choosePartTitleRole2" className=" text-[25px] font-semibold text-[#2e2c74] mt-[15px]">I'm a Teacher</h2>
                        <p id="choosePartTextRole2" className="text-[#202020] font-['Geist',sans-serif] text-[17px] font-normal w-[350px] mt-[10px] text-center">Create courses, inspire students, and make a real impact</p>
                        <a className="choosePartLinkRole font-['Geist',sans-serif] text-[17px] font-medium mt-[40px] text-[#2e2c74]">Get Started</a>
                    </div>
                </div>
                <p className="cursor-default settingsChooseText  text-[22px] font-normal text-[#2e2c74] mt-[40px]">Not sure yet? You can change this later in settings</p>
                <a id="skipRole" className="font-['Geist',sans-serif] text-[20px] font-medium mt-[20px] mb-[50px] text-[#702DFF] relative top-[20px] cursor-pointer hover:text-[#702DFF]"
